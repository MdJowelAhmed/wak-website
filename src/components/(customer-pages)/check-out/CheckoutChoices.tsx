...
export default function CheckoutChoices({
    ...
    return (
        <section className="rounded-2xl border border-card-border bg-card p-5 shadow-lg sm:p-7">
            <h2 className="mb-5 text-lg font-bold text-card-foreground">Order options</h2>
            <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                <div className="space-y-2">
                    <Label className="font-semibold text-card-foreground">Delivery option</Label>
                    <Select
                ...
                <div className="space-y-2">
                    <Label className="font-semibold text-card-foreground">Payment method</Label>
                    <Select
                        value={paymentMethod}
